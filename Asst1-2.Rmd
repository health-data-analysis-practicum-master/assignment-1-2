---
title: "Assignment 1-2: Data display and logistic regression for Question 1.1"
author: "Your Name"
date: "Today's date"
...
**Due Sunday, February 6, 2022 @ midnight through Github**

Improve your data display and fit a logistic regression to using the NMES data to answer:
...
5. As discussed in class, fit a logistic regression model to address question the question and interpret the results. Remember to use the function `glm` as shown in the notes from Wednesday's class.
...
6. When you have a your data display and logistic model ready to go, take a screenshot of your display and your model results and post on Piazza under the "Assignment 1-2 Results" thread.  You are welcome to post your screenshot anonymously to your classmates.
...
* In the window that opens, **stage** your changes by clicking the check boxes next to the `Asst1-2.Rmd` file.
