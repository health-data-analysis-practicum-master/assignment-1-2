...
**Due Sunday, February 7 @ midnight through Github**
...
5. As discussed in class, fit a logistic regression model to address question the question and interpret the results. Remember to use the function `glm` as shown in the notes from today's class.
